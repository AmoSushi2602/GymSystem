...
SELECT Id, Nome, Usuario, Senha FROM Usuarios WHERE (Id = @Id)";
    ...
    public partial class AlunosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Alunos] WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([CPF] = @Original_CPF) AND ((@IsNull_Datanascimento = 1 AND [Datanascimento] IS NULL) OR ([Datanascimento] = @Original_Datanascimento)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ([Ativo] = @Original_Ativo))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Nome", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nome", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Alunos] ([Nome], [CPF], [Datanascimento], [Telefone], [Ativo]) VALUE" +
                "S (@Nome, @CPF, @Datanascimento, @Telefone, @Ativo);\r\nSELECT Id, Nome, CPF, Data" +
                "nascimento, Telefone, Ativo FROM Alunos AS Alunos_1 WHERE (Id = SCOPE_IDENTITY()" +
                ")";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nome", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Alunos] SET [Nome] = @Nome, [CPF] = @CPF, [Datanascimento] = @Datanascimento, [Telefone] = @Telefone, [Ativo] = @Ativo WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([CPF] = @Original_CPF) AND ((@IsNull_Datanascimento = 1 AND [Datanascimento] IS NULL) OR ([Datanascimento] = @Original_Datanascimento)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)) AND ([Ativo] = @Original_Ativo));
SELECT Id, Nome, CPF, Datanascimento, Telefone, Ativo FROM Alunos AS Alunos_1 WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nome", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        Alunos_1.*\r\nFROM            Alunos AS Alunos_1";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_CPF, global::System.Nullable<global::System.DateTime> Original_Datanascimento, string Original_Telefone, bool Original_Ativo) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nome, string CPF, global::System.Nullable<global::System.DateTime> Datanascimento, string Telefone, bool Ativo) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string CPF, global::System.Nullable<global::System.DateTime> Datanascimento, string Telefone, bool Ativo, int Original_Id, string Original_Nome, string Original_CPF, global::System.Nullable<global::System.DateTime> Original_Datanascimento, string Original_Telefone, bool Original_Ativo, int Id) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string CPF, global::System.Nullable<global::System.DateTime> Datanascimento, string Telefone, bool Ativo, int Original_Id, string Original_Nome, string Original_CPF, global::System.Nullable<global::System.DateTime> Original_Datanascimento, string Original_Telefone, bool Original_Ativo) {
